                ...
                <div className="from-wrapper  w-full max-w-xl m-auto shadow-default bg-white rounded-lg border border-primary py-10 px-1">
                    ...
                    <div className="w-full max-w-sm m-auto">
                        <div className="heading text-center">
                            ...
                            <p className='text-gray-400'>Input your email and password to Log in</p>
                        </div>
                        ...
                        <div className="form">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="form-btn flex items-center justify-center">
                                    <button type="submit" className="bg-black text-white rounded-lg px-12 max-w-full my-5 py-2">
                                        Login
                                    </button>
                                </div>
                                <p className="text-gray-400 text-center">Don't have an account? <Link to="/register" className="register">Sign up</Link></p>
                            </form>
                        </div>
                    </div>
                </div>
